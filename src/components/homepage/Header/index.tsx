...
const Header = () => {
  const common = { alt: "Fashion Models", fill: true, priority: true, sizes: "100vw" };
  const {
    props: { srcSet: desktop, ...restDesktop },
  } = getImageProps({
    ...common,
  ...
  return (
    <header className="bg-[#F2F0F1] pt-10 md:pt-24 overflow-hidden">
      <div className="md:max-w-frame mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
        ...
        >
          {/* Using picture element with getImageProps for Art Direction to avoid double download */}
          <picture>
            ...
            <img
              {...restDesktop}
              alt={common.alt}
              className="object-cover object-top xl:object-[center_top_-1.6rem] w-full h-full"
            />
          </picture>
